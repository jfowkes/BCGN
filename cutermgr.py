...
the SIFDEC enavironmental variable so that it contains the path to the folder 
...
module1.extra_link_args.append('-Wl,-no_compact_unwind')
...
libraries=['gfortran']
library_dirs=['/usr/local/Cellar/gcc/7.2.0_1/lib/gcc/7/']
"""
...
def _cachePath():
	...
	if 'PYCUTER_CACHE' in os.environ:
		return os.environ['PYCUTER_CACHE']
	else:
		return os.getcwd()
