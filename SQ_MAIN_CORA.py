...
from SQ_BCGN_savinginfo_BFGS_and_invH_5D_plus50_DEADLY_DUO import SQ_BCGN_savinginfo_BFGS_and_invH_5D_plus50_DEADLY_DUO
from SQ_BCGN_savinginfo_BFGS_and_invH_5D_plus50_DEADLY_DUO_Improved import SQ_BCGN_savinginfo_BFGS_and_invH_5D_plus50_DEADLY_DUO_Improved
from SQ_BCGN_savinginfo_BFGS_and_invH_4D_plus50_DEADLY_DUO_final_trial import SQ_BCGN_savinginfo_BFGS_and_invH_4D_plus50_DEADLY_DUO_final_trial
from SQ_BCGN_savinginfo_BFGS_and_invH_4D_plus50_DEADLY_DUO_final_trial_2 import SQ_BCGN_savinginfo_BFGS_and_invH_4D_plus50_DEADLY_DUO_final_trial_2
from SQ_BCGN_savinginfo_BFGS_and_invH_4D_plus50_DEADLY_DUO_final_trial_2_BFGS_only import SQ_BCGN_savinginfo_BFGS_and_invH_4D_plus50_DEADLY_DUO_final_trial_2_BFGS_only
from SQ_BCGN_savinginfo_BFGS_and_invH_4D_plus50_DEADLY_DUO_BFGS_only import SQ_BCGN_savinginfo_BFGS_and_invH_4D_plus50_DEADLY_DUO_BFGS_only
from SQ_BCGN_savinginfo_BFGS_and_invH_4D_plus50_DEADLY_DUO_BFGS_only_corrected_coupling_11_aug import SQ_BCGN_savinginfo_BFGS_and_invH_4D_plus50_DEADLY_DUO_BFGS_only_corrected_coupling_11_aug
...
#!!!!!!!!#KEEP JUST THE PROBLEM YOU WANT!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    problems_you_want=(11,1,4,10,20,22,27,30)
        ...
        for ikappa, kappa in enumerate(kappas):
            ...
            for ip, p in enumerate(blocks):
                ...
                for iseed, seed in enumerate(seeds):
                    ...
                    # Run RBCGN
                    if PLOT: # Plotting
                        Ys[:,:,iseed] = SQ_BCGN_savinginfo_BFGS_and_invH_4D_plus50_DEADLY_DUO_BFGS_only_corrected_coupling_11_aug(r,J,x0,sampling_func,sampling_func2,fxopt,IT_MAX,FTOL,p,fig,kappa,func,iseed,algorithm=ALG)
                    else: # performance profiles - THIS IS WHERE RBCGN is called
                        measures[ifunc,ishift+ip,:,iseed] = SQ_BCGN_savinginfo_BFGS_and_invH_4D_plus50_DEADLY_DUO_BFGS_only_corrected_coupling_11_aug(r,J,x0,sampling_func,sampling_func2,fxopt,IT_MAX,FTOL,p,None,kappa,func,iseed,algorithm=ALG)
