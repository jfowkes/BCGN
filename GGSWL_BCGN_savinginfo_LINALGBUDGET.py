...
def GGSWL_BCGN_savinginfo_LINALGBUDGET(r, J, x0, sampling_func_adaptive, sampling_func, fxopt, it_max, ftol, p, fig, kappa, function_name, run_counter,algorithm='tr'):
    n = x0.size
    ...
    max_number_of_gradients=round(max_number_of_gradients*5)
    ...
    while (not fig and budget < it_max*n*n) or (fig and k < it_max and ma.fabs(f(x) - fxopt) > ftol):
