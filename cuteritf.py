...
#ifdef PYDEBUG
	fprintf(df, "PyCUTEr: Calling CUTEST_cdimen\n");
#endif
	CUTEST_cdimen((integer *)&status, (integer *)&funit, (integer *)&CUTEr_nvar, (integer *)&CUTEr_ncon);
#ifdef PYDEBUG
...
#ifdef PYDEBUG
	fprintf(df, "PyCUTEr: Calling CUTEST_[uc]setup\n");
#endif
	int IOBUFFER;
	if (CUTEr_ncon > 0)
		CUTEST_csetup((integer *)&status, (integer *)&funit, (integer *)&iout, (integer *)&IOBUFFER, (integer *)&CUTEr_nvar, (integer *)&CUTEr_ncon, x, bl, bu,
				v, cl, cu, (logical *)equatn, (logical *)linear,
				(integer *)&efirst, (integer *)&lfirst, (integer *)&nvfrst);
	else
		CUTEST_usetup((integer *)&status, (integer *)&funit, (integer *)&iout, (integer *)&IOBUFFER, (integer *)&CUTEr_nvar, x, bl, bu);
#ifdef PYDEBUG
	fprintf(df, "PyCUTEr:   n = %-d, m = %-d\n", CUTEr_nvar, CUTEr_ncon);
#endif

#ifdef PYDEBUG
	fprintf(df, "PyCUTEr: Calling CUTEST_[uc]vartype\n");
#endif
	if (CUTEr_ncon > 0)
		CUTEST_cvartype((integer *)&status, (integer *)&CUTEr_nvar, (integer *)vartypes);
	else
		CUTEST_uvartype((integer *)&status, (integer *)&CUTEr_nvar, (integer *)vartypes);
...
#ifdef PYDEBUG
	fprintf(df, "PyCUTEr: Calling CUTEST_[cu]dimsh\n");
#endif
	if (CUTEr_ncon>0)
		CUTEST_cdimsh((integer *)&status, (integer *)&CUTEr_nnzh);
	else 
		CUTEST_udimsh((integer *)&status, (integer *)&CUTEr_nnzh);
		
	if (CUTEr_ncon > 0) {
#ifdef PYDEBUG
		fprintf(df, "PyCUTEr: Calling CUTEST_cdimsj\n");
#endif
		CUTEST_cdimsj((integer *)&status, (integer *)&CUTEr_nnzj);
...
#endif
	CUTEST_probname((integer *)&status, CUTEr_probName);
...
#ifdef PYDEBUG
	fprintf(df, "PyCUTEr: calling CUTEST_varnames\n");
#endif
	CUTEST_varnames((integer *)&status, (integer *)&CUTEr_nvar, Fvnames);
...
#ifdef PYDEBUG
		fprintf(df, "PyCUTEr: calling CUTEST_connames\n");
#endif
		CUTEST_connames((integer *)&status, (integer *)&CUTEr_ncon, Fcnames);
...
#ifdef PYDEBUG
	fprintf(df, "PyCUTEr: calling CUTEST_cfn\n");
#endif
	CUTEST_cfn((integer *)&status, (integer *)&CUTEr_nvar, (integer *)&CUTEr_ncon, x, f, c);
...
static PyObject *cuter_obj(PyObject *self, PyObject *args) {
	...
	if (CUTEr_ncon == 0) {
		if (PyObject_Length(args)==1) {
			CUTEST_uofg((integer *)&status, (integer *)&CUTEr_nvar, x, f, NULL, &somethingFalse);
			return (PyObject *)Mf; 
		} else {
			CUTEST_uofg((integer *)&status, (integer *)&CUTEr_nvar, x, f, g, &somethingTrue);
			return decRefTuple(PyTuple_Pack(2, Mf, Mg)); 
		}
	} else {
		if (PyObject_Length(args)==1) {
			CUTEST_cofg((integer *)&status, (integer *)&CUTEr_nvar, x, f, NULL, &somethingFalse);
			return (PyObject *)Mf; 
		} else {
			CUTEST_cofg((integer *)&status, (integer *)&CUTEr_nvar, x, f, g, &somethingTrue);
			return decRefTuple(PyTuple_Pack(2, Mf, Mg)); 
		}
	}
}
...
#ifdef PYDEBUG
	fprintf(df, "PyCUTEr: calling CUTEST_ccfg/CUTEST_ccifg\n");
#endif
	if (!wantSingle) {
		if (!derivs) {
			CUTEST_ccfg((integer *)&status, (integer *)&CUTEr_nvar, (integer *)&CUTEr_ncon, x, c,
		...
		if (!derivs) {
			CUTEST_ccifg((integer *)&status, (integer *)&CUTEr_nvar, (integer *)&icon, x, c, NULL, &somethingFalse);
			return (PyObject *)Mc; 
		} else {
			CUTEST_ccifg((integer *)&status, (integer *)&CUTEr_nvar, (integer *)&icon, x, c, J, &somethingTrue);
			return decRefTuple(PyTuple_Pack(2, Mc, MJ)); 
		}
	}
}
...
#ifdef PYDEBUG
	fprintf(df, "PyCUTEr: calling CUTEST_cgr\n");
#endif
	if (!lagrangian) {
		CUTEST_cgr((integer *)&status, (integer *)&CUTEr_nvar, (integer *)&CUTEr_ncon, x, NULL, &somethingFalse, 
			g, &somethingFalse, (integer *)&CUTEr_ncon, (integer *)&CUTEr_nvar, J);
	} else {
		CUTEST_cgr((integer *)&status, (integer *)&CUTEr_nvar, (integer *)&CUTEr_ncon, x, v, &somethingTrue,
			g, &somethingFalse, (integer *)&CUTEr_ncon, (integer *)&CUTEr_nvar, J);
	}
...
#ifdef PYDEBUG
	fprintf(df, "PyCUTEr: calling CUTEST_cjprod\n");
#endif
	if (!transpose) {
		if (arg3==NULL) {
			CUTEST_cjprod((integer *)&status, (integer *)&CUTEr_nvar, (integer *)&CUTEr_ncon, &somethingTrue,
					&somethingFalse, NULL, p, (integer *)&CUTEr_nvar, r, (integer *)&CUTEr_ncon);
		} else {
			CUTEST_cjprod((integer *)&status, (integer *)&CUTEr_nvar, (integer *)&CUTEr_ncon, &somethingFalse,
...
#ifdef PYDEBUG
	fprintf(df, "PyCUTEr: calling CUTEST_[cu]dh\n");
#endif
	if (CUTEr_ncon>0) {
		CUTEST_cdh((integer *)&status, (integer *)&CUTEr_nvar, (integer *)&CUTEr_ncon, x, v, (integer *)&CUTEr_nvar, H);
	} else {
		CUTEST_udh((integer *)&status, (integer *)&CUTEr_nvar, x, (integer *)&CUTEr_nvar, H);
	}
...
#ifdef PYDEBUG
	fprintf(df, "PyCUTEr: calling CUTEST_cidh/CUTEST_udh\n");
#endif
	if (CUTEr_ncon>0) {
		CUTEST_cidh((integer *)&status, (integer *)&CUTEr_nvar, x, (integer *)&icon, (integer *)&CUTEr_nvar, H);
	} else {
		CUTEST_udh((integer *)&status, (integer *)&CUTEr_nvar, x, (integer *)&CUTEr_nvar, H);
	}
...
static PyObject *cuter_hprod(PyObject *self, PyObject *args) {
	...
	if (CUTEr_ncon>0) {
		if (arg2==NULL)
			CUTEST_chprod((integer *)&status, (integer *)&CUTEr_nvar, (integer *)&CUTEr_ncon, &somethingTrue, NULL, NULL, p, r);
		else 
			CUTEST_chprod((integer *)&status, (integer *)&CUTEr_nvar, (integer *)&CUTEr_ncon, &somethingFalse, x, v, p, r);
	} else {
		if (arg2==NULL)
			CUTEST_uhprod((integer *)&status, (integer *)&CUTEr_nvar, &somethingTrue, NULL, p, r);
		else 
			CUTEST_uhprod((integer *)&status, (integer *)&CUTEr_nvar, &somethingFalse, x, p, r);
	}
...
#ifdef PYDEBUG
	fprintf(df, "PyCUTEr: calling CUTEST_[cu]grdh\n");
#endif
	if (CUTEr_ncon>0) {
		CUTEST_cgrdh((integer *)&status, (integer *)&CUTEr_nvar, (integer *)&CUTEr_ncon, x, v, (logical *)&grlagf,
				g, &somethingFalse, (integer *)&CUTEr_ncon, (integer *)&CUTEr_nvar, J, (integer *)&CUTEr_nvar, H);
		return decRefTuple(PyTuple_Pack(3, Mg, MJ, MH)); 
	} else {
		CUTEST_ugrdh((integer *)&status, (integer *)&CUTEr_nvar, x, g, (integer *)&CUTEr_nvar, H);
...
#ifdef PYDEBUG
		fprintf(df, "PyCUTEr: calling CUTEST_ccfsg\n");
#endif
		CUTEST_ccfsg((integer *)&status, (integer *)&CUTEr_nvar, (integer *)&CUTEr_ncon, x, c, (integer *)&CUTEr_nnzj,
...
#ifdef PYDEBUG
		fprintf(df, "PyCUTEr: calling CUTEST_ccifsg\n");
#endif
		CUTEST_ccifsg((integer *)&status, (integer *)&CUTEr_nvar, (integer *)&index, x, c, (integer *)&nnzsgc, (integer *)&CUTEr_nvar, sv, (integer *)si, &somethingTrue);
...
#ifdef PYDEBUG
	fprintf(df, "PyCUTEr: calling CUTEST_csgr\n");
#endif
	/* Must use different variable for output NNZJ and input LCJAC */
	if (!lagrangian) {
		CUTEST_csgr((integer *)&status, (integer *)&CUTEr_nvar, (integer *)&CUTEr_ncon, x, NULL, &somethingFalse, 
				(integer *)&nnzjplusno, (integer *)&nnzjplusn, sv, (integer *)si, (integer *)sfi);
	} else {
		CUTEST_csgr((integer *)&status, (integer *)&CUTEr_nvar, (integer *)&CUTEr_ncon, x, v, &somethingTrue,
				(integer *)&nnzjplusno, (integer *)&nnzjplusn, sv, (integer *)si, (integer *)sfi);
	}
...
#endif
	if (CUTEr_ncon>0) {
		CUTEST_csh((integer *)&status, (integer *)&CUTEr_nvar, (integer *)&CUTEr_ncon, x, v, (integer *)&nnzho, (integer *)&CUTEr_nnzh, 
			sv, (integer *)si, (integer *)sj);
	} else {
		CUTEST_ush((integer *)&status, (integer *)&CUTEr_nvar, x, (integer *)&nnzho, (integer *)&CUTEr_nnzh, 
			sv, (integer *)si, (integer *)sj);
	}
...
#ifdef PYDEBUG
	fprintf(df, "PyCUTEr: calling CUTEST_cish/CUTEST_ush\n");
#endif
	if (CUTEr_ncon>0) {
		CUTEST_cish((integer *)&status, (integer *)&CUTEr_nvar, x, (integer *)&icon, (integer *)&nnzho, (integer *)&CUTEr_nnzh, sv, (integer *)si, (integer *)sj);
	} else {
		CUTEST_ush((integer *)&status, (integer *)&CUTEr_nvar, x, (integer *)&nnzho, (integer *)&CUTEr_nnzh, sv, (integer *)si, (integer *)sj);
	}
...
#ifdef PYDEBUG
		fprintf(df, "PyCUTEr: calling CUTEST_csgrsh\n");
#endif
		if (lagrangian) {
			CUTEST_csgrsh((integer *)&status, (integer *)&CUTEr_nvar, (integer *)&CUTEr_ncon, x, v, &somethingTrue,
			...
			CUTEST_csgrsh((integer *)&status, (integer *)&CUTEr_nvar, (integer *)&CUTEr_ncon, x, v, &somethingFalse,
					(integer *)&nnzjplusno, (integer *)&nnzjplusn, sjv, (integer *)sji, (integer *)sjfi, 
					(integer *)&nnzho, (integer *)&CUTEr_nnzh, sv, (integer *)si, (integer *)sj);
		}
...
#ifdef PYDEBUG
		fprintf(df, "PyCUTEr: calling CUTEST_ugrsh\n");
#endif
		CUTEST_ugrsh((integer *)&status, (integer *)&CUTEr_nvar, x, g, (integer *)&nnzho, (integer *)&CUTEr_nnzh, sv, (integer *)si, (integer *)sj);
	}
