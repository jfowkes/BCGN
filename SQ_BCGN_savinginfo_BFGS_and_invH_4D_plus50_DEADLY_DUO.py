...
def SQ_BCGN_savinginfo_BFGS_and_invH_4D_plus50_DEADLY_DUO(r, J, x0, sampling_func_adaptive, sampling_func, fxopt, it_max, ftol, p, fig, kappa, function_name, run_counter,algorithm='tr'):
    n = x0.size
