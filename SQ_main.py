...
from SQ_BCGN_savinginfo_BFGS_and_invH_4D import SQ_BCGN_savinginfo_BFGS_and_invH_4D
from SQ_BCGN_savinginfo_BFGS_and_invH_4D_2 import SQ_BCGN_savinginfo_BFGS_and_invH_4D_2
...
#!!!!!!!!#KEEP JUST THE PROBLEM YOU WANT!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    problems_you_want=(1,4,10,11,12,20,22,27,28,30)
   #problems_you_want=(31,3,7,9,15,16,17)
        ...
        for ikappa, kappa in enumerate(kappas):
            ...
            for ip, p in enumerate(blocks):
                ...
                for iseed, seed in enumerate(seeds):
                    ...
                    # Run RBCGN
                    if PLOT: # Plotting
                        Ys[:,:,iseed] = SQ_BCGN_savinginfo_BFGS_and_invH_4D_2(r,J,x0,sampling_func,sampling_func2,fxopt,IT_MAX,FTOL,p,fig,kappa,func,iseed,algorithm=ALG)
                    else: # performance profiles - THIS IS WHERE RBCGN is called
                        measures[ifunc,ishift+ip,:,iseed] = SQ_BCGN_savinginfo_BFGS_and_invH_4D_2(r,J,x0,sampling_func,sampling_func2,fxopt,IT_MAX,FTOL,p,None,kappa,func,iseed,algorithm=ALG)
