...
def SQ_BCGN_savinginfo_BFGS_and_invH_4D_plus50_DEADLY_DUO_final_trial_2(r, J, x0, sampling_func_adaptive, sampling_func, fxopt, it_max, ftol, p, fig, kappa, function_name, run_counter,algorithm='tr'):
    n = x0.size
    ...
    #save data------part 1]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]
        ...
        if k==0 and kappa==1 and p==2:#initializae the hessian -and also update it
            ...
            if ex_step_no==1: #if we took a succesful step in S1
                ...
                old_GN_matrix=BFGS_update(old_GN_matrix,grad_current-previous_grad,current_location-previous_location)
