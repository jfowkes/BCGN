...
def SQ_BCGN_savinginfo_BFGS_and_invH_4D_plus50_DEADLY_DUO_BFGS_only(r, J, x0, sampling_func_adaptive, sampling_func, fxopt, it_max, ftol, p, fig, kappa, function_name, run_counter,algorithm='tr'):
    n = x0.size
    ...
    #save data------part 1]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]
        ...
        if k==0 and kappa==1 and p==2:#initializae the hessian -and also update it
            ...
            if ex_step_no==1: #if we took a succesful step in S1
                ...
                old_GN_matrix_1=BFGS_update_hessian(old_GN_matrix_1,current_location_1-previous_location_1,grad_current_1-previous_grad_1)  
               ...
               old_GN_matrix_2=BFGS_update_hessian(old_GN_matrix_2,current_location_2-previous_location_2,grad_current_2-previous_grad_2)  
